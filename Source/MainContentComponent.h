...
public:
    ...
    TrackEditor track2Editor;
    TrackEditor track3Editor;
    TrackEditor track4Editor;
    TrackEditor track5Editor;
    TrackEditor track6Editor;
    TrackEditor track7Editor;
    TrackEditor track8Editor;
